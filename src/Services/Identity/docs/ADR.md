...
| **ADR-ID-016** | [معمارية التفويض القائمة على مجموعات الصلاحيات الوسيطة والأدوار الديناميكية](#-adr-id-016-معمارية-التفويض-القائمة-على-مجموعات-الصلاحيات-الوسيطة-والأدوار-الديناميكية-dynamic-rbac-with-reusable-permission-groups) | مُعتمد (Approved) | فصل الصلاحيات الذرية عن باقات العمل لتحقيق أعلى مرونة وإعادة استخدام للأدوار. |
